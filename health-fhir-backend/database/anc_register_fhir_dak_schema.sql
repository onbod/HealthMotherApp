...
-- ==============================================
-- NOTIFICATIONS TABLE (FHIR: Communication + DAK) - FHIR/DAK compliant
-- ==============================================
...
CREATE INDEX idx_reports_image_urls ON reports USING GIN(image_urls);

CREATE INDEX idx_notifications_fhir_id ON notifications(fhir_id);
CREATE INDEX idx_notifications_patient_id ON notifications(patient_id);
CREATE INDEX idx_notifications_recipient_id ON notifications(recipient_id);
CREATE INDEX idx_notifications_is_read ON notifications(is_read);
CREATE INDEX idx_notifications_type ON notifications(type);
CREATE INDEX idx_notifications_status ON notifications(status);
CREATE INDEX idx_notifications_trimester ON notifications(trimester);
CREATE INDEX idx_notifications_visit ON notifications(visit);
CREATE INDEX idx_notifications_weeks ON notifications(weeks);
